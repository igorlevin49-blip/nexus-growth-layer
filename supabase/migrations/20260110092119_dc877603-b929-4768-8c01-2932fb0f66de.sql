-- Fix: profiles table does not have personal_activation_volume or is_activated.
-- Map activation flag from monthly_activation_completed and set volume to 0 for now.
...
BEGIN
  ...
  SELECT 
    ...
    0::numeric as personal_activation_volume,
