-- Restore full get_referral_network_from_table function with all comments and logic
-- Fixed: has_commission_received now correctly joins through subscriptions table
...
BEGIN
  ...
  SELECT 
    ...
    -- FIX: source_id contains subscription_id, so we join through subscriptions table
    ...
    -- Only applicable for structure 1 (S1)
    CASE
