-- Fix get_referral_network_from_table to show EARNED commissions instead of payments made
...
BEGIN
  ...
  SELECT 
    ...
    -- Monthly volume: EARNED commissions for this user in current month
    COALESCE((
