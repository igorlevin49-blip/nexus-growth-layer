-- Исправление award_s1_subscription_commission - добавляем уровень в source_ref
  ...
  WHILE v_current_level <= v_max_level LOOP
    ...
    IF v_commission_amount > 0 THEN
      ...
      IF v_sponsor_subscription_status = 'active' AND v_sponsor_monthly_activation = true THEN
        -- Create frozen commission transaction (amount in whole KZT)
...
-- Исправление create_commission_transactions - добавляем уровень в source_ref
